...
type ApmFormula1 struct {
	...
	Value_1_BB      string   	`json:"value_1_bb"`
	Value_1_BA      string   	`json:"value_1_ba"`
	Value_2_BB      string    	`json:"value_2_bb"`
	Value_2_BA      string    	`json:"value_2_ba"`
	Value_3_BB      string    	`json:"value_3_bb"`
	Value_3_BA      string    	`json:"value_3_ba"`
	Value_4_BB      string    	`json:"value_4_bb"`
	Value_4_BA      string    	`json:"value_4_ba"`
	Value_5_BB      string    	`json:"value_5_bb"`
	Value_5_BA      string    	`json:"value_5_ba"`
